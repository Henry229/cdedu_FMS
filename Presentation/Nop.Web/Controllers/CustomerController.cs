...
namespace Nop.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        [NopHttpsRequirement(SslRequirement.Yes)]
        public ActionResult LoginAdmin(bool? checkoutAsGuest)
        {
            var model = new LoginModel();
            model.UsernamesEnabled = _customerSettings.UsernamesEnabled;
            model.CheckoutAsGuest = checkoutAsGuest.HasValue ? checkoutAsGuest.Value : false;
        ...
        public ActionResult Login_CS(string username, string usercode)
        {
            ...
            var loginResult = _customerRegistrationService.ValidateCustomer(_customerSettings.UsernamesEnabled ? username : "", usercode);
                switch (loginResult)
                {
                    case CustomerLoginResults.Successful:
                        {
                            var customer = _customerSettings.UsernamesEnabled ? _customerService.GetCustomerByUsername(username) : _customerService.GetCustomerByEmail("");
        ...
        [HttpPost]
        [CaptchaValidator]
        public ActionResult LoginAdmin(LoginModel model, string returnUrl, bool captchaValid)
        {
            returnUrl = "/Admin";
