...
{
    public class ClosingModel : BaseNopEntityModel
    {
        public ClosingModel()
        {
        ...
        [NopResourceDisplayName("Admin.Omni_Backoffice.Closing.Fields.Id")]
        [AllowHtml]
        ...
        [NopResourceDisplayName("Admin.Omni_Backoffice.Closing.Fields.SEQ")]
