    ...
    public partial class NewsController : BaseAdminController
	{
            ...
            var gridModel = new DataSourceResult
            {
                Data = news.Select(x =>
                {
                    ...
                    if (x.StartDateUtc.HasValue)
                        ...
                        m.StartDate = x.StartDateUtc;
                    if (x.EndDateUtc.HasValue)
                        //m.EndDate = _dateTimeHelper.ConvertToUserTime(x.EndDateUtc.Value, DateTimeKind.Utc);
                        m.EndDate = x.EndDateUtc;
        ...
        public ActionResult Create(NewsItemModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                newsItem.CreatedOnUtc = _dateTimeHelper.ConvertToUserTime(DateTime.UtcNow, DateTimeKind.Utc);
