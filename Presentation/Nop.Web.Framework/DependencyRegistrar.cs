...
namespace Nop.Web.Framework
{
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            //services   ########################## OMNI service HERE!!!! ################################
            builder.RegisterType<CodeMasterService>().As<ICodeMasterService>().InstancePerHttpRequest();
            ...
            builder.RegisterType<ItemSetService>().As<IItemSetService>().InstancePerHttpRequest();
            builder.RegisterType<OrderService_Omni>().As<IOrderService_Omni>().InstancePerHttpRequest();
            builder.RegisterType<OrderService_Omni>().As<IOrderService_Omni>().InstancePerHttpRequest();
            builder.RegisterType<CourseMasterService>().As<ICourseMasterService>().InstancePerHttpRequest();
            builder.RegisterType<OrderService_Omni>().As<IOrderService_Omni>().InstancePerHttpRequest();
            builder.RegisterType<CalendarMasterService>().As<ICalendarMasterService>().InstancePerHttpRequest();
            builder.RegisterType<RoyaltyService>().As<IRoyaltyService>().InstancePerHttpRequest();
            builder.RegisterType<CampusService>().As<ICampusService>().InstancePerHttpRequest();
            builder.RegisterType<PdfService_Omni>().As<IPdfService_Omni>().InstancePerHttpRequest();
            builder.RegisterType<ClassService>().As<IClassService>().InstancePerHttpRequest();
            builder.RegisterType<PdfService_Class>().As<IPdfService_Class>().InstancePerHttpRequest();
            builder.RegisterType<PrintService>().As<IPrintService>().InstancePerHttpRequest();
